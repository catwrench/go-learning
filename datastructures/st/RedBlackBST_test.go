...
func InitTestRedBlackBST() *RedBlackBST[int, string] {
	arr1 := Input1()
	st := NewRedBlackBST[int, string]()
	for i := range arr1 {
...
func TestRedBlackBSTDel(t *testing.T) {
	st := InitTestRedBlackBST()
...
func TestRedBlackBSTMin(t *testing.T) {
	st := InitTestRedBlackBST()
...
func TestRedBlackBSTMax(t *testing.T) {
	st := InitTestRedBlackBST()
...
func TestRedBlackBSTKeys(t *testing.T) {
	st := InitTestRedBlackBST()
	str := ""
...
func TestRedBlackBSTSelect(t *testing.T) {
	st := InitTestRedBlackBST()
