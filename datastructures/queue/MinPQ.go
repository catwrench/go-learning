...
func (m *MinPQ) Less(firstIdx, secondIdx int) bool {
	return m.queue[firstIdx] < m.queue[secondIdx]
}

func (m *MinPQ) Exchange(firstIdx, secondIdx int) {
	m.queue[firstIdx], m.queue[secondIdx] = m.queue[secondIdx], m.queue[firstIdx]
}

// Swim 元素上浮
func (m *MinPQ) swim(index int) {
